...
public:
	...
	void RowIsEpt(int iRow,int Cols,int &Flag);
	BOOL IsEpt(int i,int j);
	...
	BOOL SetColumnNoEditable(int nCol);         //我的函数  设置不能编辑的列
	BOOL GetColumnNoEditable(int nCol);         //我的函数  得到不能编辑的列的数
	//******************************************************************************//
...
public:
	...
	BOOL AddComboColumn(int iCol, CStringArray& comStr);	//20190911新增
