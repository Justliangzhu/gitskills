...
class RoadAutoDesignDlg : public CDialog
{
	DECLARE_DYNAMIC(RoadAutoDesignDlg)

public:
	RoadAutoDesignDlg(CWnd* pParent = NULL);   // 标准构造函数
	virtual ~RoadAutoDesignDlg();

// 对话框数据
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_DIALOG_AUTODESIGN };
#endif
