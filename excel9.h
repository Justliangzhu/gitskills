...
public:
	...
	LPDISPATCH GetRows();
	VARIANT Run(const VARIANT& Macro);  
	VARIANT Run(const VARIANT& Macro, const VARIANT& Arg);  
...
public:
	...
	LPDISPATCH GetCells();
	LPDISPATCH GetCell(const int Row, const int Col);
	LPDISPATCH ChartObjects(const VARIANT& Index);
	void CheckSpelling(const VARIANT& CustomDictionary, const VARIANT& IgnoreUppercase, const VARIANT& AlwaysSuggest, const VARIANT& SpellLang);
	...
	LPDISPATCH GetRange(const VARIANT& Cell1, const VARIANT& Cell2);
	LPDISPATCH GetRange(const VARIANT& Cell);
	LPDISPATCH GetRows();
...
class FontXls : public COleDispatchDriver
{
public:
	FontXls() {}		// Calls COleDispatchDriver default constructor
	FontXls(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	FontXls(const FontXls& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
